<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLogin.aspx.cs" Inherits="AppLoginAndRegister.frmLogin" %>
        ...
        <div class="formcontent">
            <form id="formulario_login" runat="server">
                <div class="form-control">
                    ...
                    <br />
                    <div class="row">
                        <asp:Button ID="BtnRegistro" CssClass="btn btn-primary btn-dark" runat="server" Text="Registrarse" OnClick="btnRegistro_Click" />
                    </div>
                </div>
            </form>
        </div>
